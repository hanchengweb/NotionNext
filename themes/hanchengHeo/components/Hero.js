  ...
  return (
    <div
      ...
      <div
        ...
        className={
          'z-20 rounded-xl overflow-hidden opacity-0 group-hover:opacity-100 duration-300 transition-all bg-[#2a9d8fdd] dark:bg-[#40b3a2] dark:text-white cursor-pointer absolute w-full h-full top-0 flex justify-start items-center'
        }>
...
function GroupMenu() {
  ...
  return (
    <div className='h-[165px] select-none xl:h-20 flex flex-col justify-between xl:space-y-0 xl:flex-row w-28 lg:w-48 xl:w-full xl:flex-nowrap xl:space-x-3'>
      <Link
        href={url_1}
        className='group relative overflow-hidden bg-gradient-to-r from-[#2a9d8f] to-[#40b3a2] flex h-20 justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in'>
      ...
      <Link
        href={url_2}
        className='group relative overflow-hidden bg-gradient-to-r from-[#e76f51] to-[#f4a261] flex h-20 justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in'>
        <div className='font-bold lg:text-lg pl-5 relative -mt-2'>
          {title_2}
          <span className='absolute -bottom-0.5 left-5 w-5 h-0.5 bg-white rounded-full'></span>
        </div>
      ...
      <Link
        href={url_3}
        className='group relative overflow-hidden bg-gradient-to-r from-[#457b9d] to-[#1d3557] hidden h-20 xl:flex justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in'>
          ...
          return (
            <Link href={`${siteConfig('SUB_PATH', '')}/${p?.slug}`} key={index}>
              <div className='cursor-pointer h-[164px] group relative flex flex-col w-52 xl:w-full overflow-hidden shadow bg-white dark:bg-black dark:text-white rounded-xl'>
                ...
                />
                <div className='group-hover:text-[#2a9d8f] dark:group-hover:text-[#57c4b5] line-clamp-2 overflow-hidden m-2 font-semibold'>
                  {p?.title}
                </div>
                {/* hover 悬浮的 '荐' 字 */}
                <div className='opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 duration-200 transition-all absolute -top-2 -left-2 bg-[#2a9d8f] dark:bg-[#40b3a2] text-white rounded-xl overflow-hidden pr-2 pb-2 pl-4 pt-4 text-xs'>
