  ...
  return (
    <div id='sideRight' className='hidden xl:block w-72 space-y-4 h-full'>
      ...
      <div className='sticky top-20 space-y-4'>
        ...
        <div
          className={
            'border wow fadeInUp  hover:border-green-600  dark:hover:border-yellow-600 duration-200 dark:border-gray-700 dark:bg-[#1e1e1e] dark:text-white rounded-xl lg:p-6 p-4 hidden lg:block bg-white'
          }>
        ...
        <Card
          className={
            'bg-white dark:bg-[#1e1e1e] dark:text-white hover:border-green-600  dark:hover:border-yellow-600 duration-200'
          }>
