          ...
          return (
            <div key={index} className=''>
              <Link
                ...
                target={link?.target}
                className={
                  'w-full flex items-center justify-between py-1 hover:scale-105 duration-200 transform dark:hover:text-green-400 hover:text-green-600 px-2 cursor-pointer'
                }>
                <>
                  <div>{link.name} :</div>
