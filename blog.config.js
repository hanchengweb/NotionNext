// 注: process.env.XX是Vercel的环境变量，配置方式见：https://github.com/hanchengweb/NotionNext
...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hanchengHeo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hancheng', // 您的昵称 例如 hancheng
  BIO: process.env.NEXT_PUBLIC_BIO || '我是韩诚一个专注于AI编程，AI自动化的博主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hancheng.blog/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '韩诚的博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片
